	...
	<div class="hk-wrapper hk-alt-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt">
            ...
            <a class="navbar-brand" href="dashboard1.html">
                <img class="brand-img d-inline-block align-top" src="{{ asset('dashboard/dist/img/logo-light.png')}}" alt="brand" />
            </a>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown show-on-hover active">
                        ...
                        <div class="dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            <a class="dropdown-item" href="{{ route('main') }}">Front</a>
                    ...
                    <li class="nav-item dropdown show-on-hover">
                        ...
                        <div class="dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            ...
                            <a class="dropdown-item" href="{{ route('dash.users.index') }}">All User</a>
                        ...
                        <div class="notifications-nicescroll-bar">
                                ...
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('dashboard/dist/img/avatar1.jpg')}}" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="{{ asset('dashboard/"dist/img/avatar2.jpg')}}" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div>
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="{{ asset('dashboard/dist/img/avatar12.jpg')}}" alt="user" class="avatar-img rounded-circle">
                                </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        <form method ="post" action="{{route('logout')}}" id="logoutform" >
                            ...
                            <button  form="logoutform" class="dropdown-item" ><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></button>
                        </form>
                        </div>
        ...
        <div class="hk-settings-panel">
                    ...
                    <div class="layout-img-wrap">
                        <div class="row">
                            <a href="dashboard1.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="{{ asset('dashboard/dist/img/layout1.png')}}" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="dashboard2.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="{{ asset('dashboard/dist/img/layout2.png')}}" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                            <a href="javascript:void(0);" class="col-6 active mb-30">
                                <img class="rounded opacity-70" src="{{ asset('dashboard/dist/img/layout3.png')}}" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
							<a href="dashboard4.html" class="col-6 mb-30">
                                <img class="rounded opacity-70" src="{{ asset('dashboard/dist/img/layout4.png')}}" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
							<a href="dashboard5.html" class="col-6">
                                <img class="rounded opacity-70" src="{{ asset('dashboard/dist/img/layout5.png')}}" alt="layout">
                                <i class="zmdi zmdi-check"></i>
                            </a>
                        </div>
                    </div>
            ...
            <img class="d-none" src="{{ asset('dashboard/dist/img/logo-light.png')}}" alt="brand" />
            <img class="d-none" src="{{ asset('dashboard/dist/img/logo-dark.png')}}" alt="brand" />
        </div>
        <!-- /Setting Panel -->
    <!-- Main Content -->
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header">
                    <div>
						<h2 class="hk-pg-title font-weight-600 mb-10">@yield('title')</h2>
