 <div id="qvmodal"></div>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="{{ asset('front/assets/images/logo.png ')}}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('front/assets/images/payment-icon/1.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('front/assets/images/payment-icon/2.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('front/assets/images/payment-icon/3.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{ asset('front/assets/images/payment-icon/4.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                        </ul>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <img src="{{ asset('front/assets/images/newletter-icon.png ')}}" class="img-fluid blur-up lazyload" alt="">
                        ...
                        <div>
                            ...
                            <div class="modal-product">
                                <div class="modal-contain-img">
                                    <img src="{{ asset('front/assets/images/fashion/instagram/4.jpg')}}" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
    ...
    <script src="{{ asset('front/assets/js/price-filter.js')}}"></script>
    <script src="{{ asset('front/assets/js/ion.rangeSlider.min.js')}}"></script>
    <script src="{{ asset('front/assets/js/filter.js')}}"></script>
    <script src="{{ asset('front/assets/js/newsletter.js')}}"></script>
    <script src="{{ asset('front/assets/js/cart_modal_resize.js')}}"></script>
